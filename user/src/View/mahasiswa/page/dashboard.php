                        ...
                        <div class="row g-3 flex-column flex-md-row">
                            ...
                            <div class="col-12 col-md-3 text-center">
                                <img alt="Profile Picture" src="<?= $profile->foto_mahasiswa ?>"
                                    class=" img-fluid rounded mb-2" style="max-width: 80%; height: auto;" />
                ...
                <div class="col-lg-5">
                    <div class="bg-white p-3 position-relative">
                        ...
                        <div class="alert alert-danger">
                            <p class="fw-semibold">Anda mendapatkan laporan Pelanggaran baru, segera periksa di data
                                pelanggaran</p>
                            <a href="/dataPelanggaran" class="btn btn-danger mt-2 mb-1"><i
